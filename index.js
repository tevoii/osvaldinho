...
const zeksApi = 'apivinz';
const nomd = '⏤͟͟͞͞ঔৣ͜͡TEVØ⏤͟͟͞͞🔥';
const line = '║';
const line2 = '╠➥';
const line7 = '*Em breve*';
const line3 = '╠══✪〘';
const line4 = '〙✪══';
const line5 = '⏤͟͟͞͞ঔৣ͜͡TEVØ⏤͟͟͞͞🔥 DOMINA';
const line6 = 'APIS DO TEVO';
const line8 = '╠═══════════════';
const line9 = '╠══';
const line10 = 'EDITS »';
const line11 = 'Dono:';
const line12 = '*wa.me/+555491057713*';
const line13 = 'Bot: ON';
const line14 = '*4.0*';
const line15 = '╔══✪〘 ';
const line16 = '*MENU*';
const root = 'Darkbot';
const line17 = '*Osvaldinho bot*';
...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Tevo\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=555491057713:+55 549105-7713\n' //Nomor whatsapp kamu
            + 'END:VCARD'
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
					...
					levelnol: '*error* 0 °-°',
					error: {
				stick: '*sistema de figurinhas nao funciona no momento*',
				Iv: '𝗠𝗮𝗮𝗳 𝗹𝗶𝗻𝗸 𝘁𝗶𝗱𝗮𝗸 𝘃𝗮𝗹𝗶𝗱☹️'
				},
				only: {
					group: '[❗] Este comando só pode ser usado em grupos! ❌',
					premium: '[❗] ESTE PEDIDO É SO PARA *USUÁRIOS PREMIUMS*',
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD OSVALDINHO BOT*',
			...
			const ownerNumber = ["555491057713@s.whatsapp.net","12267740582@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"555491057713@s.whatsapp.net"]//ubah nomor lo
...
break
case 'anotaaplaca':
tujuh = fs.readFileSync('./bi/anotaaplaca.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'cavala':
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOO OSVALDINHO BOT 👑* 」\n\`\`\``
					no = 0
